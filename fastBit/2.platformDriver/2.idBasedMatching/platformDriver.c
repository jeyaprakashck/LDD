...
struct deviceConfigStruct deviceConfig[] = {
	[MYDEVA1X] = {.configItem1 = 11, .configItem2 = 0},
	[MYDEVB1X] = {.configItem1 = 22, .configItem2 = 0},
	[MYDEVC1X] = {.configItem1 = 33, .configItem2 = 0},
	[MYDEVD1X] = {.configItem1 = 44, .configItem2 = 0}
};
...
int myPlatformDriverProbe(struct platform_device *platformDevice){
	...
	pr_info("Device config data = %d\n", deviceConfig[platformDevice->id_entry->driver_data].configItem1);
...
struct platform_device_id myPlatformDeviceIDs[] = {
	[0] = {.name = "myDevA1x", .driver_data = MYDEVA1X},
	[1] = {.name = "myDevB1x", .driver_data = MYDEVB1X},
	[2] = {.name = "myDevC1x", .driver_data = MYDEVC1X},
	[3] = {}
};
...
struct platform_driver myPlatformDriver = {
	...
	/* device matching order will 1.DT based, 2.IDtable based, 3.Name based */
	.id_table = myPlatformDeviceIDs,
